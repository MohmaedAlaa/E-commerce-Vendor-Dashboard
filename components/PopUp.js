...
export default function PopUp () {
  ...
  return (
    ...
    <Modal open={open} onClose={onCloseModal} center  classNames=" border rounded-[10px]">
      <div className='p-3'>
        <h1 className='text-[24px]'>Tracking Info</h1>
        <hr></hr>
        <div className='flex row'>
          <div class="w-full md:w-1/2 pr-5 mb-6 md:mb-0 my-5">
            <label class="block uppercase tracking-wide text-[#232323] text-[16px] mb-2" for="tracking-id">
              Tracking Id
            </label>
          ...
          <div class="w-full md:w-1/2 mb-6 md:mb-0 my-5">
            <label class="block uppercase tracking-wide text-[#232323] text-[16px] mb-2" for="tracking-carrier">
              Tracking Carrier
            </label>
        ...
        <div>
          ...
          <div className='mt-6 absolute w-full left-[475px]'>
            <button type="button" class=" w-1/6 focus:outline-none text-[#232323] bg-white hover:opacity-[90%] font-medium rounded-[10px] text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-white dark:hover:bg-white dark:focus:ring-white" onClick={()=>onCloseModal()}>Cancel</button>
            <button type="button" class=" w-1/6 focus:outline-none text-white bg-[#3D897A] hover:opacity-[90%] font-medium rounded-[10px] text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-[#3D897A] dark:hover:bg-[#3D897A] dark:focus:ring-[#3D897A]">Apply</button>
          </div>
          </div>
      </div>
    </Modal>
